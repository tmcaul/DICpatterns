function [topcell, cellInfo, infoIn, infoOut, cellRect] = PutCell(topcell, cad, cellInfo, layerMap, log, cellname, varargin)
...
%     cellRect          5 x 2       coordinates of the corners of the placed cell
%
