...
%% Project information
cad = struct('author', 'Tom', ...       % project lead author or company
  'fab', 'Imperial', ...                  % fabrication facility
  'process', 'FIB', ...          % fabrication process
  'run', 'DIC_grids', ...                  % run name
  'name', 'DIC_grids', ...             % project name
