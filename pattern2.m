...
%dir='/Users/tom/Box Sync/Patterns/Patterns_120319';
dir='D:\Tom\Box Sync\Patterns\Patterns_120319'

mkdir(dir)
cd(dir)

addpath(genpath('D:\Tom\Box Sync\Patterns'));
...
region_x=1000; % dimensions of region to be patterned in um
region_y=750;

grids=1; %grids on or off
grid_spacing=10;%grid dimension in um
grid_width=0.1; %

speckles=1; %speckles on or off
speckle_width=0.3; %in um
subset_dimension=5; %square subset dimension in um: There should be 3x3 speckles per subset. ie 9 per this no squared.
